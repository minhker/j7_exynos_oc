 ...
 #Cpu Tweaks
   ...
   echo "39000 902000:19000" > /sys/devices/system/cpu/cpu0/cpufreq/interactive/above_hispeed_delay
   ...
   echo 757000 > /sys/devices/system/cpu/cpu0/cpufreq/interactive/hispeed_freq
   chmod 644 /sys/devices/system/cpu/cpu0/cpufreq/interactive/target_loads
   echo "75 902000:85" > /sys/devices/system/cpu/cpu0/cpufreq/interactive/target_loads
   ...
   echo 545 > /sys/devices/11400000.mali/highspeed_clock
