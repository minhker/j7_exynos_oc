...
static int exynos_tmu_ect_set_information(struct platform_device *pdev)
{
	...
	for (i = 0; i < function->num_of_range; ++i) {
		...
		if ((function->range_list[i].max_frequency == 1586000)||(function->range_list[i].max_frequency == 1690000))
			function->range_list[i].max_frequency = 1794000;
	//	if ((function->range_list[i].max_frequency == 1586000)||(function->range_list[i].max_frequency == 1690000)||(function->range_list[i].max_frequency = 1794000))
		//	function->range_list[i].max_frequency = 1924000;
